...
class PowerManager(private val context: Context) {
    ...
    private var currentMode = PowerMode.BALANCED  // Default to BALANCED for good discovery with reasonable power
    ...
    fun getScanSettings(): ScanSettings {
        ...
        when (currentMode) {
            ...
            PowerMode.BALANCED -> builder
                .setScanMode(ScanSettings.SCAN_MODE_LOW_LATENCY)  // More aggressive
                .setMatchMode(ScanSettings.MATCH_MODE_AGGRESSIVE)
                .setNumOfMatches(ScanSettings.MATCH_NUM_MAX_ADVERTISEMENT)  // Detect more devices
