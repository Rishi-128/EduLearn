...
class MeshDelegateHandler(
    ...
    // File transfer delegate methods - not used by MeshDelegateHandler
    // (ChatViewModel handles these directly)
    ...
    override fun didReceiveQuiz(quizJson: String, senderPeerID: String) {
        // Quiz reception handled by ChatViewModel
        // This is a pass-through delegate method
    }
    
    override fun didReceiveSubmission(submissionJson: String, senderPeerID: String) {
        // Quiz submission handled by ChatViewModel
        // This is a pass-through delegate method
    }
}
